  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-colors focus:outline-none"
        ...
        <div className="absolute right-0 mt-2 w-40 bg-white rounded-lg shadow-lg border border-gray-200 z-50 overflow-hidden">
          {SUPPORTED_LANGUAGES.map((lang) => (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2 text-sm text-left hover:bg-gray-100 transition-colors ${
                i18n.language?.substring(0, 2) === lang.code ? 'bg-blue-50 font-medium' : ''
              }`}
            >
